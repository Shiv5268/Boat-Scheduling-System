...
<div class="bo_register_from">
		...
		<div class="row">
          <div class="col"><label>Gender</label><div class="radio-group"><label class="radio"><input type="radio" name="gender" value="1" checked>Male<span></span></label><label class="radio"><input type="radio" name="gender" value="2">Female<span></span></label><label class="radio"><input type="radio" name="gender" value="3">Other<span></span></label></div></div>
      	</div>
        <div class="row">
